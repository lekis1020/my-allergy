...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1773969523145-s9warn | 2026-03-20T01:18:43.444Z

**Codebase Map:**
  src/: middleware
  src/app/: page, route, route, route, route, route, route, route, route, route
  src/components/: ad-banner, conference-list, insights-view, auth-button, clinical-trial-monitor-panel, footer, header, mobile-bottom-nav, mobile-drawer-context, mobile-drawer
  src/hooks/: use-auth, use-bookmarks, use-clinical-trials, use-debounce, use-paper-filters, use-papers, use-trending-topics, use-trending
  src/lib/: monitor.test, monitor, conferences, journals, topics, trending-categories, client, types, notify, resend
  src/types/: database, filters, supabase
  (root): eslint.config, next.config, postcss.config, vitest.config
